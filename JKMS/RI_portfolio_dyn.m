...
%% grant parallel workers access to relevant variables
stategrid=stategrid;
u=u;
lambda=lambda;
...
K=1000; % number of actions considered simultaneously
...
for r=start_resolution:final_resolution
    ...
    while (~stable)
        ...
        save(sprintf('portfolio_solutions/portfolio_%s_Y%i_it%02i%02i_untrimmed.mat',combo,yN,r,i),'p_marg','actiongrid','stategrid','prior');
        ...
        save(sprintf('portfolio_solutions/portfolio_%s_Y%i_it%02i%02i_trimmed.mat',combo,yN,r,i),'p_marg','actiongrid','stategrid','prior');
